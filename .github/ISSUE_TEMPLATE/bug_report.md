...
cmake .. -DBOOST_ROOT=/home/SpookyCoin/boost_1_59_0
make -j4
```

**If self compiled, please provide of your SpookyCoin CMake output at the default verbosity**:
```
...
**Binary Reported:** <!-- does this issue affect zedwallet, SpookyCoind, turtle-service, miner? -->
