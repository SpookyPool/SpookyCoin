...
function usage()
{
    ...
    echo "and generates the checksum files of the SpookyCoin tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/SpookyCoin/SpookyCoin.git"
CLONE_DIR="$BUILD_DIRECTORY/SpookyCoin-buildall"
TARGET_DIR="$BUILD_DIRECTORY/SpookyCoin-releases"
DYNAMIC_RELEASE="SpookyCoin-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="SpookyCoin-${TAG_VERSION}-linux-staticboost-CLI"
